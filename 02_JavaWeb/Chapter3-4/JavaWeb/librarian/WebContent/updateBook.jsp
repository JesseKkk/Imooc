...
<html>
    ...
    <body>
        ...
        <div class="container">
            ...
            <form class="form-horizontal" enctype="multipart/form-data"  action="${pageContext.request.contextPath }/updatebook" method="post">

                <div class="form-group">
                    <label for="name" class="col-sm-2 control-label">图书编号 ：</label>
                    <div class="col-sm-8">
                        <input name="bookId"  value="${requestScope.bookId }"   class="form-control" id="bookId" readonly="readonly" >
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <select id="categoryId" name="categoryName" class="col-sm-2 form-control" style="width: auto;margin-left: 15px">
