$(function() {
	// 获取此店铺下的商品列表的URL
	var listUrl = '/storeadmin/getproductlistbystore?pageIndex=1&pageSize=999';
	// 商品下架URL
	var statusUrl = '/storeadmin/modifyproduct';
	getList();
	/**
	 * 获取此店铺下的商品列表
	 * 
			...
			.on(
					...
					function(e) {
						...
						if (target.hasClass('edit')) {
							...
							window.location.href = '/storeadmin/productoperation?productId='
