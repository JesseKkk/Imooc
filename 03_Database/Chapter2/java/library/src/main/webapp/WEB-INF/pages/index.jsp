...
<div class="gallery">
    <div class="container">
        <div class="col-md-12 gallery-grid glry-two text-right">
            <a href="/index.do?&pageNum=1" style="color:#666666;"><span class="glyphicon glyphicon-backward"></span></a>
            <a href="/index.do?&pageNum=${pageInfo.pageNum-1}" style="color:#666666;"><span class="glyphicon glyphicon-chevron-left"></span></a>
            共${pageInfo.total}条 ${pageInfo.pageNum}/${pageInfo.pages}
            <a href="/index.do?&pageNum=${pageInfo.pageNum+1}" style="color:#666666;"><span class="glyphicon glyphicon-chevron-right"></span></a>
            <a href="/index.do?&pageNum=${pageInfo.pages}" style="color:#666666;"><span class="glyphicon glyphicon-forward"></span></a>
        </div>
            ...
            <div class="col-md-3 gallery-grid " style="float:left">
                ...
                <div class="galy-info">
                    ...
                    <div class="galry">
                        ...
                        <div class="rating">
                            <c:forEach begin="1" end="${book.level}">
                                <span>☆</span>
                            </c:forEach>
                        </div>
                        <div class="clearfix"></div>
