                            ...
                            <div class="section row">
                                ...
                                <div class="col-md-2">
                                    <label for="sweetness" class="field prepend-icon">
                                        <input type="number" name="sweetness" id="sweetness" value="${cake.sweetness}" class="gui-input" placeholder="甜度..." required min="1" max="5" value="3">
