...
<html>
    ...
    <body>
        ...
        <div class="container">
            ...
            <p style="color:red;margin-left: 400px">${msg }</p>
            <form class="form-horizontal" action="${pageContext.request.contextPath }/UserServlet?method=update" method="post">
               <input type="hidden" name="uid"  value="${existUser.uid }">
                ...
                <div class="form-group">
                 ...
                 <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <input name="pwd2" class="form-control" id="password1" value="">
                    </div>
                </div>
